...
export const metadata: Metadata = {
  title: "Women's Sober Living | Manageable Living",
  description: "Learn more about our Women's Sober Living at Manageable Living.",
};

export default function Page() {
  return (
    <FadeIn>
      {/* Content auto-generated from Womens_Sober_Living_Page_Block.html */}
      <div className="bg-black min-vh-100 pb-5">
  
  
  <header className="bg-dark text-light py-5 position-relative overflow-hidden">
    <div className="container py-lg-4">
      <span className="text-warning text-uppercase small fw-bold mb-3 d-block" style={{ letterSpacing: "0.05em" }}>Programs / Women&apos;s Sober Living</span>
      <h1 className="display-4 fw-bold mb-3" style={{ fontFamily: "var(--font-heading)" }}>Women&apos;s Sober Living in Texas — Safety, Support, Sisterhood</h1>
      <p className="lead text-secondary mb-0" style={{ maxWidth: "700px" }}>A trauma-informed, gender-specific environment where women in recovery can heal, grow, and rebuild.</p>
    </div>
  </header>
  ...
  <section className="bg-charcoal">
    <div className="container-fluid p-0">
      <div className="row g-0">
        <div className="col-lg-6 d-flex align-items-center p-5" style={{ minHeight: "80vh" }}>
          <div className="w-100" style={{ maxWidth: "550px", marginLeft: "auto", marginRight: "5%" }}>
            ...
            <p className="text-light" style={{ fontSize: "1.1rem", lineHeight: 1.8 }}>
              Our women&apos;s sober living homes offer a trauma-informed, gender-specific environment where women in recovery can heal, grow, and rebuild their lives.
            </p>
            <p className="text-light" style={{ fontSize: "1.1rem", lineHeight: 1.8 }}>
              With female house managers and a strong emphasis on emotional wellness and personal dignity, our homes are designed to address the unique challenges women face in recovery.
            </p>
          </div>
        </div>
        <div className="col-lg-6 position-relative d-none d-lg-block">
          <img 
            ...
            alt="Woman smiling in an office setting" 
  ...
  <section className="py-5 bg-black">
    <div className="container py-lg-4">
      <div className="text-center mb-5">
        <h2>What&apos;s Included in Our Women&apos;s Homes</h2>
      </div>

      <div className="row g-4">
        
        <article className="col-lg-4 col-md-6 d-flex flex-column align-items-center text-center bg-charcoal p-4 rounded-4 shadow-sm h-100">
          ...
          <div className="text-secondary fw-medium">Female-only house managers</div>
        </article>

        <article className="col-lg-4 col-md-6 d-flex flex-column align-items-center text-center bg-charcoal p-4 rounded-4 shadow-sm h-100">
          <div className="text-warning mb-3" style={{ width: "48px", height: "48px" }} aria-hidden="true">
            <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"></path></svg>
          </div>
          <div className="text-secondary fw-medium">Trauma-informed care philosophy</div>
        </article>
        ...
        <article className="col-lg-4 col-md-6 d-flex flex-column align-items-center text-center bg-charcoal p-4 rounded-4 shadow-sm h-100">
          ...
          <div className="text-secondary fw-medium">Private rooms available</div>
        </article>
        ...
        <article className="col-lg-4 col-md-6 d-flex flex-column align-items-center text-center bg-charcoal p-4 rounded-4 shadow-sm h-100">
          ...
          <div className="text-secondary fw-medium">Life skills coaching: budgeting, parenting support, career guidance</div>
        </article>
        ...
        <article className="col-lg-4 col-md-6 d-flex flex-column align-items-center text-center bg-charcoal p-4 rounded-4 shadow-sm h-100">
          ...
          <div className="text-secondary fw-medium">Women&apos;s AA/NA meeting connections</div>
        </article>
        ...
        <article className="col-lg-4 col-md-6 d-flex flex-column align-items-center text-center bg-charcoal p-4 rounded-4 shadow-sm h-100">
          ...
          <div className="text-secondary fw-medium">Childcare resources and referrals (case-by-case)</div>
        </article>

        <article className="col-lg-4 col-md-6 d-flex flex-column align-items-center text-center bg-charcoal p-4 rounded-4 shadow-sm h-100" style={{gridColumn: "1 / -1", maxWidth: "400px", margin: "0 auto", }}>
          <div className="text-warning mb-3" aria-hidden="true" style={{ width: "48px", height: "48px", margin: "0 auto 24px" }}>
          ...
          <div className="text-secondary fw-medium" style={{textAlign: "center", }}>Safe, respectful, and empowering environment</div>
        </article>
  ...
  <section className="bg-charcoal text-light py-5 text-center mt-5">
    <div className="container py-lg-4">
      <h2 className="display-5 fw-bold mb-3" style={{ fontFamily: "var(--font-heading)" }}>Ready for Safety, Support, and Sisterhood?</h2>
      <p className="lead text-secondary mx-auto mb-5" style={{ maxWidth: "700px" }}>
        Beds are available in our League City and Kemah women&apos;s homes. Reach out today to start your admissions process.
      </p>
      <div className="d-flex flex-column flex-sm-row justify-content-center gap-3">
        <a href="/contact/" className="btn btn-dark rounded-pill px-5 py-3 fw-bold text-uppercase shadow-sm" aria-label="Apply online for Women&apos;s Sober Living">APPLY ONLINE</a>
